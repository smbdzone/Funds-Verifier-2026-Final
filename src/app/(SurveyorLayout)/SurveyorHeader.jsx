...
const SurveyorHeader = ({ setIsSidebarOpen, isSidebarOpen }) => {
  ...
  return (
    <div className='w-full bg-[#d9d9d9] p-5 flex justify-between lg:justify-end'>
      ...
      <div className='flex items-center gap-4 pr-5 relative'>
        ...
        {/* Notification Modal */}
        {alertActive && (
          <div className='absolute top-full mt-8 right-[80%] bg-white shadow-lg rounded-md w-[320px] z-50 flex flex-col gap-2'>
