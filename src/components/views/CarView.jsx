...
export default function CarView({ data }) {
  ...
  const detailRows = useMemo(
    () => [
      ...
      { label: 'Body Type', value: data?.carType || data?.bodyType },
      { label: 'Transmission Type', value: data?.transmissionType },
      { label: 'Steering Side', value: data?.steeringSide },
      { label: 'Fuel Type', value: data?.fuelType },
      { label: 'Engine Capacity', value: data?.engineCapacity },
      { label: 'No. of Cylinders', value: data?.noofCylinders },
      ...
      { label: 'Mechanical Condition', value: data?.mechanicalCondition },
