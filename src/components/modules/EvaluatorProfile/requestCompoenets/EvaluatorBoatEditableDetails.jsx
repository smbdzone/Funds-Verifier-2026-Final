...
import {
  colors as boatColors,
  extrasList as boatExtras,
  conditionOptions,
  usage as usageOptions,
  seller as sellerOptions,
  warrenty as warrantyOptions,
...
export default function EvaluatorBoatEditableDetails({
  property = {},
  draft,
  onDraftChange,
  onSave,
    ...
    <section className='mb-6 rounded-lg border border-[#8d7c3b]/40 bg-[#faf8f3] p-4 sm:p-5'>
      ...
      <div className='grid sm:grid-cols-2 gap-4'>
        ...
        <div>
          ...
          <select
            className={editInputClass}
            value={pickValue(draft?.length, property.length)}
        ...
        <div>
          ...
          <select
            className={editInputClass}
            value={pickValue(draft?.sellerType, property.sellerType)}
