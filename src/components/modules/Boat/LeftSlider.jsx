...
export default function BoatSlider({ setPreviewMedia, images }) {
  ...
  return (
    <div className="custom-swiper flex flex-col items-center justify-center">
              ...
              <SwiperSlide key={image.public_id || image.originalName || idx}>
                <figure className="h-full w-full sm:h-[165px] sm:w-[160px] py-1 rounded">
                  <Image
                    ...
                    src={src}
                    alt={image.originalName || "boat image"}
                    quality={90}
                    height={350}
                    width={350}
