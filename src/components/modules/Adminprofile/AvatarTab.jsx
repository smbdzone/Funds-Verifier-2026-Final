                              ...
                              {isDropdownOpen && (
                                <div className="absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg">
                                  <ul>
                                    ...
                                    >
                                      <p className=" px-4 py-2  hover:bg-gray cursor-pointer text-center pl-10  text-light-gold">
                                        Property
                                      </p>
                                      ...
                                      {isPropertyDropdownOpen && (
                                        <div className="absolute   left-[190px] top-[10%] rounded-md    mt-1">
                                          <ul className=" bg-white  w-full   text-center shadow-md ">
                                            ...
                                            <li className=" px-4 py-2 text-center hover:bg-gray cursor-pointer  whitespace-nowrap">
                        ...
                        <div className=" px-3 ">
                          <Disclosure.Panel className="gap-2 pt-8   pb-20 mb-5">
                            <div className="xl:h-[10px] xl:bg-gray relative rounded-full">
                              <div
                                className="flex xl:absolute flex-wrap xl:flex-nowrap pl-6  -top-4 xl:justify-center xl:px-7 w-full"
                                aria-label="Tabs"
                              >
                                {tabs.map((tab, i) => (
                                  <div
