...
export const BoatEvaluationTab = () => {
  ...
  const [isBoatDropdownOpen, setIsBoatDropdownOpen] = useState(false)
  const toggleDropdown = () => setIsDropdownOpen(!isDropdownOpen)
  const togglePropertyDropdown = () =>
    setIsPropertyDropdownOpen(!isPropertyDropdownOpen)
  const toggleCarDropdown = () => setIsCarDropdownOpen(!isCarDropdownOpen)
  const toggleJewelryDropdown = () =>
    setIsJewelryDropdownOpen(!isJewelryDropdownOpen)
  const toggleBoatDropdown = () => setIsBoatDropdownOpen(!isBoatDropdownOpen)
  return (
    <>
      ...
      <section className='bg-white shadow-md  py-4 '>
          ...
          {({ open }) => (
            ...
            {isDropdownOpen && (
                <div className='absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg'>
                    <ul>
                        <li
                            className='px-4 py-2 text-center hover:bg-gray cursor-pointer flex items-center   '
                        ...
                        >
                            ...
                            <span className='ml-2 text-light-gold pr-2'>
                                <DropIcon />
                            </span>
                            {isPropertyDropdownOpen && (
                                <div className='absolute   left-[190px] top-[10%] bg-white w-full   rounded-md shadow-lg mt-1'>
                                    <ul>
                                        ...
                                        <li className=' py-2 text-center hover:bg-gray cursor-pointer  whitespace-nowrap'>Residential Building</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Residential Floor</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Villa Compound</li>
                                    </ul>
                                </div>
                            )}
                        </li>
        ...
        <Switch
          ...
          className={`${
            enabled1 ? 'primary-gradient ' : 'bg-gray'
        ...
        <Switch
          ...
          className={`${
            enabled2 ? 'primary-gradient ' : 'bg-gray'
          } relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none`}
        >
          <span
            className={`${
          ...
          />
               ...
               checked={enabled}
                   onChange={setEnabled}
                className={`${enabled ? 'primary-gradient ' : 'bg-gray'}
                 relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none`}
               >
              <span
        className={`${
          ...
          {({ open }) => (
            ...
            {isDropdownOpen && (
                <div className='absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg'>
                    <ul>
                        <li
                            className='px-4 text-center hover:bg-gray cursor-pointer flex items-center justify-between'
                            onClick={togglePropertyDropdown}
                        >
                            <p className='py-2 cursor-pointer text-center'>Property</p>
                            <span className='text-light-gold '>
                                <DropIcon />
                            </span>
                            {isPropertyDropdownOpen && (
                                <div className='absolute left-[190px] top-[10%] w-full bg-white shadow-md rounded-md mt-1'>
                                    <ul className='text-center'>
                                        <li className='px-4 py-3 text-center hover:bg-gray cursor-pointer text-light-gold'>
                                            Apartment
                                        </li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Villa</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Townhouse</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Multiple</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Penthouse</li>
                                        <li className='py-2 text-center hover:bg-gray cursor-pointer whitespace-nowrap'>
                                            Residential Building
                                        </li>
                                        <li className='px-4 py-3 text-center hover:bg-gray cursor-pointer'>
                                            Residential Floor
                                        </li>
                                        <li className='px-4 py-3 text-center hover:bg-gray cursor-pointer'>Villa Compound</li>
                                    </ul>
                                </div>
                            )}
                        </li>
                        ...
                        >
                            <p className='py-2 cursor-pointer text-center'>Car</p>
                            <span className='text-light-gold'>
                                <DropIcon />
                            </span>
                            {isCarDropdownOpen && (
                                <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                    <ul className='text-center'>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer text-light-gold'>Sport car</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Honda Civic</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Jaguar</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Luxury cars</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Mercedes-Benz Cars</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Limousine cars</li>
                                    </ul>
                                </div>
                            )}
                        </li>
                        ...
                        >
                            <p className='py-2 cursor-pointer text-center'>Jewelry</p>
                            <span className='text-light-gold mr-[100px]'>
                                < DropIcon />
                            </span>
                            {isJewelryDropdownOpen && (
                                <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                    <ul className='text-center'>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer text-light-gold'>Necklace</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Ring</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Bracelet</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Earrings</li>
                                    </ul>
                                </div>
                            )}
                        </li>
              ...
              <Disclosure.Panel as='div' className='gap-4 px-8 '>
                <Disclosure as='div' className={`disclosure`} defaultOpen={false}>
                  {({ open }) => (
                    <>
                      <Disclosure.Button className={`w-full shadow-md bg-whiteSmoke mb-4 b  text-sm rounded py-3  px-7 gap-4 justify-between items-center flex ${open && "mb-3"}`}>
                        <span className='whitespace-nowrap sm:text-xl font-medium text-black/80'>Sport Car</span>
                        <span className='flex-shrink-0'>
                          {open ? <OpenDisclosure className='text-black/80' /> : <CloseDisclosure className='text-black/30' />}
                        </span>
                      </Disclosure.Button>
                ...
                <Disclosure.Panel as='div' className='gap-4 px-8  '>
                  ...
                  >
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`w-full  mb-2.5  shadow-md text-sm rounded py-3 px-7  justify-between items-center flex ${
                            open && ''
                          }`}
                        >
                          <span className='whitespace-nowrap sm:text-xl font-medium text-black/80'>
                            Asset Reference Number SN 12367845
                          </span>
                          <span className='flex-shrink-0'>
                            {open ? (
                        ...
                        >
                            ...
                            <div className='relative bg-whiteSmoke w-full flex justify-between py-3 pl-5 rounded-md items-center'>
                              ...
                              {isDropdownOpen && (
                                <div className='absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg'>
                                  <ul>
                                    <li
                                      className='px-4 text-center hover:bg-gray cursor-pointer flex items-center'
                                      onClick={togglePropertyDropdown}
                                    >
                                      <p className='px-4 py-2 hover:bg-gray cursor-pointer text-center pl-10'>
                                        Property
                                      </p>
                                      <span className='mr-[8px] text-light-gold'>
                                        <DropIcon />
                                      </span>
                                      {isPropertyDropdownOpen && (
                                        <div className='absolute left-[190px] top-[10%] w-full bg-white shadow-md rounded-md mt-1'>
                                    ...
                                    <li
                                      ...
                                      onClick={toggleCarDropdown}
                                    >
                                      <p className='px-4 py-2 hover:bg-gray cursor-pointer text-center pl-14 '>
                                        Car
                                      </p>
                                      <span className='text-light-gold ml-[28px]'>
                                        <DropIcon />
                                      </span>
                                      {isCarDropdownOpen && (
                                        <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                          <ul className='text-center'>
                                            <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer text-light-gold'>
                                              Sport car
                                            </li>
                                            <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>
                                              Honda Civic
                                    ...
                                    <li
                                      className='px-4 text-center hover:bg-gray cursor-pointer flex items-center'
                                      onClick={toggleBoatDropdown}
                                    >
                                      <p className='px-4 py-2 hover:bg-gray cursor-pointer text-center pl-14 text-light-gold'>
                                        Boat
                                      </p>
                                      <span className='text-light-gold ml-[15px]'>
                                        <DropIcon />
                                      </span>
                                      {isBoatDropdownOpen && (
                                        <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                    ...
                                    <li className='px-4 text-center hover:bg-gray cursor-pointer flex items-center'>
                                      <p className='px-4 py-2 hover:bg-gray cursor-pointer text-center pl-12 '>
                                        Jewelry
                                      </p>
                                    </li>
                                  </ul>
                          ...
                          <textarea
                            ...
                            id=''
                            rows={4}
                            className='outline-none w-full mb-3 pl-5 pt-4 rounded-md  bg-whiteSmoke  pb-1 text-lg  '
                ...
                <Disclosure.Panel as='div' className='gap-4 px-8 '>
                  ...
                  >
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`w-full shadow-md bg-whiteSmoke mb-4  text-sm rounded py-3  px-7 gap-4 justify-between items-center flex ${
                            open && 'mb-3'
                          }`}
                        >
                          <span className='whitespace-nowrap sm:text-xl font-medium text-black/80'>
                        ...
                        <div className='flex items-center justify-between w-full'>
                          <Disclosure.Panel
                            as='div'
                            className='gap-2 px-8  flex items-center mb-2.5    justify-between w-full'
                          >
                            <div className='w-full text-center mb-2'>
                        ...
                        <div className='flex items-center justify-between  w-full'>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Title Deed/Pre Title Deed/Lease
                                Deed/Oqood/Initial Contract of Sale
                              </span>
                            </div>
                            <div className='flex gap-3'>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                NOC from Developer and final as built drawings
                                If extended/improved
                              </span>
                            </div>
                            <div className='flex gap-3 '>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Owners NOC if he is not client (for corporate
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Completion Status Certificate from Engineering
                                Co, if under construction
                              </span>
                            </div>
                            <div className='flex gap-3 '>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          <Disclosure.Panel
                            as='div'
                            className='gap-2 px-8 flex mb-2.5  items-center justify-between w-full'
                          >
                            <div className='flex items-center'>
                              <span>MOU of Sale</span>
                            </div>
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Costs/Invoices Sheet of the Upgrades if any
                              </span>
                            </div>
                            <div className='flex gap-3 '>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Upgrade Development Consultancy Contract
                              </span>
                            </div>
                            <div className='flex gap-3 '>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          ...
                          >
                            <div className='flex items-center'>
                              <span>
                                Upgrade Development Contracting Contract
                              </span>
                            </div>
                            <div className='flex gap-3 '>
                              <span>
                        ...
                        <div className='flex items-center justify-between '>
                          <Disclosure.Panel
                            as='div'
                            className='gap-2 px-8 flex mb-1  items-center justify-between w-full'
                          >
                            <div className='flex items-center'>
                              <span>extended</span>
                              <div className='flex items-center space-x-4 pl-2'>
                            ...
                            <div className='flex items-center justify-between  gap-4'>
                              ...
                              <div className='flex gap-2 items-center'>
                                ...
                                <Switch
                                  ...
                                  onChange={setEnabled}
                                  className={`${
                                    enabled ? 'primary-gradient ' : 'bg-gray'
                                  }
                 relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none`}
                                >
                                  <span
