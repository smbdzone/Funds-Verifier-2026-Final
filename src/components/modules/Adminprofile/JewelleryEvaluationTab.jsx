...
export const JewelleryEvaluationTab = () => {
  ...
  const toggleJewelryDropdown = () => setIsJewelryDropdownOpen(!isJewelryDropdownOpen);
                    ...
                    <ul>
                        ...
                        >
                            ...
                            {isPropertyDropdownOpen && (
                                <div className='absolute  w-full left-[190px] top-[10%] bg-white  rounded-md shadow-lg mt-1'>
                                    <ul>
            ...
            {isDropdownOpen && (
                <div className='absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg'>
                    <ul>
                        ...
                        <li
                            ...
                            onClick={toggleJewelryDropdown}
                        >
                            <p className='px-4 py-2 hover:bg-gray cursor-pointer text-center pl-12 text-light-gold'>
                                Jewelry
                            </p>
                            <span className='text-light-gold ml-[1px]'>
                                <DropIcon />
                            </span>
                            {isJewelryDropdownOpen && (
                                <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                    <ul className='text-center'>
                                        ...
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Ring Jewelry</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Earring Jewelry</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Bracelets Jewelry</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Diamond Ring</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Jewelry Set</li>
                                    </ul>
                                </div>
                            )}
                        </li>
                            ...
                            {isBoatDropdownOpen && (
                                <div className='absolute left-[190px] top-[10%] bg-white w-full shadow-md rounded-md mt-1'>
                                    <ul className='text-center'>
                                        ...
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Fishing Boats</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Catamaran Boarts</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Bowrider Boats</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Pontoon boats</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Police watercraft</li>
                                        <li className='px-4 py-2 text-center hover:bg-gray cursor-pointer'>Powerboat</li>
                                    </ul>
                                </div>
                            )}
                        </li>
              ...
              <Disclosure.Panel as='div' className='gap-4 px-8 '>
                <Disclosure as='div' className={`disclosure`} defaultOpen={true}>
                  {({ open }) => (
                    <>
                      <Disclosure.Button className={`w-full shadow-md bg-whiteSmoke mb-4  text-sm rounded py-3  px-7 gap-4 justify-between items-center flex ${open && "mb-3"}`}>
                        <span className='whitespace-nowrap sm:text-xl font-medium text-black/80'>Sport Car</span>
                        <span className='flex-shrink-0'>
                          {open ? <OpenDisclosure className='text-black/80' /> : <CloseDisclosure className='text-black/30' />}
                        </span>
