                                ...
                                <div className='absolute right-0 mt-2 top-[30px] bg-white w-[50%] rounded-md shadow-lg'>
                                  <ul>
                                    ...
                                    >
                                      ...
                                      <span className=' text-light-gold ml-[26px] '>
                                        <DropIcon />
                                      </span>
                                      {isCarDropdownOpen && (
                ...
                <Disclosure.Panel as='div' className='gap-4 px-8 '>
                  ...
                  >
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`w-full shadow-md bg-whiteSmoke mb-4 b  text-sm rounded py-3  px-7 gap-4 justify-between items-center flex ${
                            open && 'mb-3'
                          }`}
                        >
                          <span className='whitespace-nowrap sm:text-xl font-medium text-black/80'>
