...
import car from "@/assets/images/rectangle-86@2x.png";
import jeep from '@/assets/images/Mask group (2).png'
import lemozine from '@/assets/images/Mask group (3).png'

export default function CarsSaleSlide() {
  return (
            ...
            <div className="flex flex-row items-center justify-between">
              <div className=" flex flex-row gap-4 items-center">
                <img
                  ...
                  src={house.src}
                />
                <div className=" text-lg font-medium text-[#000000]">Ref: 12390876</div>
              </div>
